...
class LocalYOLOEngine(IDetector):
    ...
    def __init__(self, ctrl: Optional[IController] = None, *, weights: Optional[str] = None, use_gpu: Optional[bool] = None):
        self.ctrl = ctrl
    ...
    def recognize(
        ...
        *,
        ...
        if self.ctrl is None:
            raise RuntimeError("LocalYOLOEngine.recognize() requires a controller injected in the constructor.")
